...
public class StockPortfolio {
	...
	ArrayList<Stocks> listOfStocks = new ArrayList<>();
	public static int bal = 100000;
	
	static Scanner sc = new Scanner(System.in);
	
	public StockPortfolio(ArrayList<Stocks> listOfStocks) {
	...
	public void addPortfolio(Stocks stock) {
	...
	public void displayPortfolio() {
		...
		for(Stocks stockToPrint : this.listOfStocks) {
	...
	public int calculateTotalValue() {
		...
		int totalValue = 0;
		for(Stocks stock : this.listOfStocks){
